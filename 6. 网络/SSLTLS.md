# SSL/TLS
#6. 网络/HTTP#
[HTTPS、SSL、TLS三者之间的联系和区别 - Enweitech Software Works - CSDN博客](https://blog.csdn.net/enweitech/article/details/81781405)
- - - -
* Secure Socket Layer是基于HTTPS下的一个协议加密层。
* 在SSL3.0的基础上开发出了TLS1.0（Tranport Layer Security，安全传输层协议）。

1. SSL(Secure Sockets Layer安全套接层),及其继任者传输层安全（Transport Layer Security，TLS）是为网络通信提供安全及数据完整性的一种安全协议。TLS与SSL在传输层对网络连接进行加密。
